...
{
mouseClick, left,x+256,y+117,1,0
sleep, speed
}
else
{
...
WINDOW1(x, y, speed, colorMatch)
{
PixelGetColor, color,x+-200,y+775-4
StringTrimLeft, color, color, 2
ifEqual, color,%colorMatch%
{
mouseClick, left,x+-200,y+775,1,0
sleep, speed
}
else
{
...
{
PixelGetColor, color,x+397,y+185
StringTrimLeft, color, color, 2
ifEqual, color,%colorMatch%
{
if (boolean = false)
